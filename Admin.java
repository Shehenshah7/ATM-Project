...
public class Admin {
	...
	public void createAccount() {
		if (accounts.length > count) {
			...
			System.out.println(
					ConsoleColors.GREEN + "*********** Account Created Successfully ********" + ConsoleColors.RESET);

			System.out.println(ConsoleColors.YELLOW + "<---------------Your Account Details are------------->"
					+ ConsoleColors.RESET);
	...
	public void viewAllAccounts() {
		if (count > 0) {
			for (int i = 0; i < this.count; i++) {
				System.out.println(ConsoleColors.YELLOW + "<-------------- Account-" + (i + 1)
						+ "-------------------------------->" + ConsoleColors.RESET);
	...
	public void deleteAccount(String AccountNumber) {
		...
		for (int i = 0; i < this.count; i++) {
			...
			if (accounts[i].getAccNo().equals(AccountNumber)) {
				...
				System.out.println(
						ConsoleColors.RED + "There is no such type of Account number in my bank" + ConsoleColors.RESET);
				break;
			}
